...
public class GeneradorHtml {
	...
	public static StringBuilder generaDirRemoto(String credencial, ListaFicheros listadoRemoto,
		...
		String hiperenlace = Constantes.DESCARGA + "?" + Constantes.CREDENCIAL_VAR + "=" +
							credencial + "&" + Constantes.USUARIO_REMOTO_VAR + "=" +
							nick + "&" + Constantes.FICHERO_VAR + "=";
...
/*		HtmlForm f = page.addForm(Constantes.ENVIAR_MENSAJE);
	 ...
	 * 
	 */
	public static StringBuilder generaEnviarPeticionDescarga(String credencial, String resultado){
		Html page = new Html();
		
		page.setTile(Constantes.TERMINAL + "Resultado de petición de descarga");
		page.addBr();
		HtmlP p = page.addP();
		p.addText("Resultado de petición de descarga: " + resultado);
		p.setAlign(HtmlP.AlignType.CENTER);
