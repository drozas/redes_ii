...
public class Validacion {
	 ...
	 * @param	host	Host del peer remoto, para guardarlo en nuestra estrucutra de datos
	 ...
	 */
	public static int ValidarUsuario(String nick, String clave, Usuario infoPeer, String host, Map<String,String> infoCredenciales){
		...
		try
		{
			...
			infoPeer.CargarConfiguracionPeer(path_config_usuario, host);
