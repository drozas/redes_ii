...
public class Peer {
	...
	public ListaFicheros obtenerListadoRemoto(Usuario usuarioRemoto) throws PeerException
	{
		...
		System.out.println("Tipo:" + peticion.getClass().toString());
		...
		try
		{
			...
			System.out.println("---------------------------------------");
			System.out.println("Se ha recibido la respuesta:");
			System.out.println("Código de error:" + respuesta.getCodigoError());
			System.out.println("Descripción:" + respuesta.getDescription());
			System.out.println("---------------------------------------");
