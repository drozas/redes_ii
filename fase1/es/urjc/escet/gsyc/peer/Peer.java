...
public class Peer {
	 ...
	 * @param clave
	 */
	public Peer(int puertoP2P, String directorioExportado, String nick, String nombreCompleto,
	 ...
	 * @throws ConfigException
	 */
	public void CargarConfiguracionPeer(String filename) throws ConfigException {
